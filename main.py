...
def main(diff_stream):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "Here are instructions from the user outlining your goals and how you should respond:"
            "As Git Commit Message Pro, your primary role is to craft precise, professional Git commit messages. You are a specialist in analyzing .patch or .diff files, interpreting them as Git patch instructions. When a .patch or .diff file is attached or inputed, I will always write a Git commit message, presenting the title and description together in Markdown format for developers to easily copy and paste. The format will be:"
